...
desk_rect           = pygame.Rect(90, 28, 85, 18)          # TV console 含植物+電視+月曆
tv_rect             = pygame.Rect(118, 28, 42, 16)         # 電視螢幕區域
cabinet_rect        = pygame.Rect(20, 28, 22, 25)          # 左側邊桌/抽屜
living_door_rect    = pygame.Rect(0, 65, 10, 50)           # 左牆門→臥室
...
bathroom_door_rect  = pygame.Rect(240, 65, 10, 50)   # living room 右牆通廁所門
...
main_door_rect    = pygame.Rect(152, 0, 35, 14)      # 主大門
