...
|------|----------------------|--------|--------|------|
| `desk_rect` | `(120, 32, 90, 50)` | 120–210 | 32–82 | 電視桌整體碰撞範圍 |
| `calendar_rect` | `(190, 50, 14, 12)` | 124–138 | 35–47 | 月曆圖示（= desk.x+4, desk.y+3） |
| `tv_rect` | `(145, 32, 40, 35)` | 145–185 | 32–67 | 電視螢幕 |
| `cabinet_rect` | `(25, 35, 40, 50)` | 20–48 | 35–85 | 左側抽屜桌 |
| `living_door_rect` | `(15, 100, 10, 80)` | 15–25 | 80–160 | 左牆門 → 臥室 |
| `bathroom_door_rect` | `(300, 100, 10, 80)` | 288–298 | 80–160 | 右牆門 → 廁所 |
| `main_door_rect` | `(225, 28, 52, 10)` | 140–192 | 30–48 | 上牆大門 |
| `sofa_rect` | `(110, 190, 100, 50)` | 100–200 | 210–260 | 沙發 |
...
| 物件 | inflate | 最終大小 |
|------|---------|---------|
| 月曆（calendar） | `calendar_rect.inflate(5, 48)` | 36×56 |
| 電視（tv） | `tv_rect.inflate(5, 50)` | 56×51 |
| cabinet | `cabinet_rect.inflate(16, 16)` | 56×66 |
| living_door | `living_door_rect.inflate(50, 0)` | 20×100 |
| bathroom_door | `bathroom_door_rect.inflate(50, 0)` | 30×100 |
| main_door | `main_door_rect.inflate(5, 50)` | 57×35 |
