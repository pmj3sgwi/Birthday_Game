...
|------|----------------------|--------|--------|------|
| `desk_rect` | `(90, 28, 85, 18)` | 90–175 | 28–46 | 電視桌（月曆觸發使用此 centerx） |
| `tv_rect` | `(118, 28, 42, 16)` | 118–160 | 28–44 | 電視螢幕 |
| `cabinet_rect` | `(20, 28, 22, 25)` | 20–42 | 28–53 | 左側抽屜桌 |
| `living_door_rect` | `(0, 65, 10, 50)` | 0–10 | 65–115 | 左牆門 → 臥室（x=0 固定） |
| `bathroom_door_rect` | `(240, 65, 10, 50)` | 240–250 | 65–115 | 右牆門 → 廁所 |
| `main_door_rect` | `(152, 0, 35, 14)` | 152–187 | 0–14 | 上牆大門（y=0 固定） |
