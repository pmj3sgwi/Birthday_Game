...
> 每次新增或修改物件時同步更新此檔。  
> 修改後將數值填回 `retro_game.py` 對應行，再 commit + push。
...
|------|----------------------|--------|--------|------|
| `desk_rect` | `(95, 32, 128, 30)` | 95–223 | 32–62 | 電視桌（月曆觸發使用此 centerx） |
| `tv_rect` | `(145, 32, 58, 26)` | 145–203 | 32–58 | 電視螢幕 |
| `cabinet_rect` | `(5, 30, 32, 36)` | 5–37 | 30–66 | 左側抽屜桌 |
| `living_door_rect` | `(0, 67, 12, 84)` | 0–12 | 67–151 | 左牆門 → 臥室 |
| `bathroom_door_rect` | `(308, 67, 12, 84)` | 308–320 | 67–151 | 右牆門 → 廁所 |
| `main_door_rect` | `(214, 0, 42, 19)` | 214–256 | 0–19 | 上牆大門（玄關） |
| `sofa_rect` | `(71, 180, 162, 44)` | 71–233 | 180–224 | 沙發（純裝飾，無互動） |
