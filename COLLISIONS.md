...
|------|----------------------|--------|--------|------|
| `desk_rect` | `(95, 33, 128, 30)` | 95–223 | 33–63 | 電視桌（月曆觸發使用此 centerx） |
| `tv_rect` | `(143, 33, 58, 26)` | 143–201 | 33–59 | 電視螢幕 |
| `cabinet_rect` | `(15, 31, 32, 36)` | 15–47 | 31–67 | 左側抽屜桌（貼齊左牆 min_x=15） |
| `living_door_rect` | `(0, 67, 12, 84)` | 0–12 | 67–151 | 左牆門 → 臥室（固定） |
| `bathroom_door_rect` | `(308, 67, 12, 84)` | 308–320 | 67–151 | 右牆門 → 廁所（固定） |
| `main_door_rect` | `(209, 0, 42, 19)` | 209–251 | 0–19 | 上牆大門（玄關，y=0 固定） |
| `sofa_rect` | `(72, 178, 162, 44)` | 72–234 | 178–222 | 沙發（純裝飾，無互動） |
